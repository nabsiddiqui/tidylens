---
title: "Getting Started with Tinylens"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Getting Started with Tinylens}
...
# Tinylens: Image-First Analysis for Digital Humanities

Tinylens provides a **tidy, pipeable API** for analyzing visual content. It's designed for **film studies**, **digital humanities**, and anyone who wants to extract quantitative features from images.
...
Tinylens makes it easy to go from **video → frames → analysis**:
...
Tinylens automatically detects **shot boundaries** (scene cuts):
...
Tinylens can extract **audio features** aligned to your video frames or shots. This lets you analyze the **sound** alongside the **visuals**.
...
Tinylens integrates with **Ollama** for AI-powered image analysis:
